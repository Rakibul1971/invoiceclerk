 ...
 * License: GPL2
 */
use LunarBite\ManualSettelement\ManualSettelement;
 ...
 *
 * @return \LunarBite\ManualSettelement\ManualSettelement
 */
function lunarbite_manual_settelement() {
    return ManualSettelement::init();
}

// Lets Go....
lunarbite_manual_settelement();
