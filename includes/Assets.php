...
class Assets {
	...
	public function register_scripts() {
		...
		wp_register_script( 'manual_settelement_admin_script', $admin_script, array(), MANUAL_SETTELEMENT_PLUGIN_VERSION, true );
	...
	public function register_styles() {
		...
		wp_register_style( 'manual_settelement_admin_style', $admin_style, array(), MANUAL_SETTELEMENT_PLUGIN_VERSION );
